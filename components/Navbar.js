    ...
    <div className='z-10 flex flex-col items-center justify-center md:flex-row md:justify-start bg-gray-900 shadow-md shadow-green-400 overflow-visible sticky top-0'>
      ...
      <div className="nav">
        <ul className='flex items-center space-x-6 font-bold md:text-md px-10 text-white'>
          <Link href={'/tshirts'}><a className='hover:text-slate-500'><li>T-Shirts</li></a></Link>
          <Link href={'/hoodies'}><a className='hover:text-slate-500'><li>Hoodies</li></a></Link>
          <Link href={'/stickers'}><a className='hover:text-slate-500'><li>Stickers</li></a></Link>
          <Link href={'/mugs'}><a className='hover:text-slate-500'><li>Mugs</li></a></Link>
        </ul>
      </div>
      <div ref={ref} className="cart space-x-2 flex absolute right-0 top-7 mx-5 text-green-300 cursor-pointer">

        {/* Accounts and Cart Icons */}
        <Link href={'/login'}>
          <MdAccountCircle className='text-xl md:text-2xl hover:text-slate-500' />
        </Link>
      ...
      <div ref={ref} className="cart w-72 h-[90vh] absolute top-0 right-0 bg-green-200 px-8 py-10 rounded-md mt-14 transform transition-transform translate-x-full">
