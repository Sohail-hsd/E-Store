    ...
    return (
        <div className='flex flex-col mx-4'>
            ...
            <input {...inputProps} onChange={onChange} onBlur={onFocus} focused={Focus}
                className='infoInputs bg-gray-800 rounded-md focus:border-green-500 focus:ring-2 focus:ring-green-500 text-base outline-none text-gray-300 py-1 my-2 px-3 leading-8 transition-colors duration-200 ease-in-out'
            />
