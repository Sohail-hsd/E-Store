        ...
        <form className="mt-8 space-y-6" action="#" method="POST">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <Link href={'/forgot'}>
                <a href="#" className="font-medium text-green-600 hover:text- -500"> Forgot your password? </a>
              </Link>
            </div>
          </div>
