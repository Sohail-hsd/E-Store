                                                                ...
                                                                <td class="pad" style="padding-bottom:20px;padding-left:10px;padding-right:10px;padding-top:10px;">
                                                                    <div style="font-family: sans-serif">
                                                                        <div class style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #8412c0; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
                                                                            <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;"><span style="color:#8a3b8f;">e-store.com © ·</span><span style> </span><span style><a href="http://[unsubscribe]/" target="_blank" rel="noopener" style="color: #8412c0;">Unsuscribe</a></span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
...
async function main() {
    ...
    let info = await transporter.sendMail({
        from: '"Fred Foo 👻" <knight.hsd19@gmail.com.com>', // sender address
...
export default async function handler(req, res) {
    if (req.body.sendMail) {
        ...
        // Reset Password
        return res.status(200).json({ success: true, name: 'reseted' })
    }
