  ...
  const fetchUserInfo = async () => {
    ...
    if (token) {
      ...
      if (response.data && response.userInfo) {
        setUser({ data: response.data, userInfo: response.userInfo })
        console.log(User)
                  ...
                  {sideNav === "Edit Profile" ?
                    ...
                    <div>
                      ...
                      <h3 className="text-4xl font-semibold leading-normal text-white mb-2">
                        {user.value ? user.value.UserName : 'User Name'}
                      </h3>

                      <div className="text-sm leading-normal mt-0 mb-2 text-gray-400 font-semibold ">
                      ...
                      <div className="mb-2 text-gray-400 mt-1">
                        <i className="fas fa-briefcase mr-2 text-sm text-gray-400">
                          Address : {User.userInfo !== null ? User.userInfo.address : "address"}
                        </i>
                      </div>
                      <div className="mb-2 text-gray-400 mt-1">
                        <i className="fas fa-briefcase mr-2 text-sm text-gray-400">
                          City : {User.userInfo !== null ? User.userInfo.city : "city"}
                        </i>
                      </div>
                      <div className="mb-2 text-gray-400 mt-1">
                        <i className="fas fa-briefcase mr-2 text-sm text-gray-400">
                          Phone : {User.userInfo !== null ? User.userInfo.phone : "Phone"}
                        </i>
                      </div>
                      <div className="mb-2 text-gray-400 mt-1">
                        <i className="fas fa-briefcase mr-2 text-sm text-gray-400">

                          Area Pin Code : {User.userInfo !== null ? User.userInfo.areaPinCode : "Area Pin Code"}
                        </i>
                      </div>
